  ...
  whichIconImage() {
    if (response!.current!.weather![0].icon == "01d") {
      ...
      return Image.asset("assets/weather_icons/partlycloudy_day.png");
        ...
        response!.current!.weather![0].id.toString() == "803") {
      return Image.asset("assets/weather_icons/partlycloudy_day.png");
    } else if (response!.current!.weather![0].icon == "04d" &&
        response!.current!.weather![0].id.toString() == "804") {
      return Image.asset("assets/weather_icons/cloudy.png");
    } else if (response!.current!.weather![0].icon == "09d" &&
        response!.current!.weather![0].id.toString() == "300") {
      return Image.asset("assets/weather_icons/lightrainshowers_day.png");
    } else if (response!.current!.weather![0].icon == "09d" &&
        response!.current!.weather![0].id.toString() == "301") {
      return Image.asset("assets/weather_icons/lightrainshowers_day.png");
    } else if (response!.current!.weather![0].icon == "09d" &&
        response!.current!.weather![0].id.toString() == "302") {
      return Image.asset("assets/weather_icons/heavyrainshowers_day.png");
    } else if (response!.current!.weather![0].icon == "09d" &&
        response!.current!.weather![0].id.toString() == "310") {
      return Image.asset("assets/weather_icons/lightrainshowers_day.png");
    } else if (response!.current!.weather![0].icon == "09d" &&
        response!.current!.weather![0].id.toString() == "311") {
      return Image.asset("assets/weather_icons/lightrain.png");
    } else if (response!.current!.weather![0].icon == "09d" &&
        response!.current!.weather![0].id.toString() == "312") {
      return Image.asset("assets/weather_icons/heavyrainshowers_day.png");
    } else if (response!.current!.weather![0].icon == "09d" &&
        response!.current!.weather![0].id.toString() == "313") {
      return Image.asset("assets/weather_icons/lightrainshowers_day.png");
    } else if (response!.current!.weather![0].icon == "09d" &&
        response!.current!.weather![0].id.toString() == "314") {
      return Image.asset("assets/weather_icons/heavyrainshowers_day.png");
    } else if (response!.current!.weather![0].icon == "09d" &&
        response!.current!.weather![0].id.toString() == "321") {
      return Image.asset("assets/weather_icons/lightrainshowers_day.png");
    } else if (response!.current!.weather![0].icon == "09d" &&
        response!.current!.weather![0].id.toString() == "520") {
      return Image.asset("assets/weather_icons/lightrainshowers_day.png");
    } else if (response!.current!.weather![0].icon == "09d" &&
        response!.current!.weather![0].id.toString() == "521") {
      return Image.asset("assets/weather_icons/lightrainshowers_day.png");
    } else if (response!.current!.weather![0].icon == "09d" &&
        response!.current!.weather![0].id.toString() == "522") {
      return Image.asset("assets/weather_icons/heavyrainshowers_day.png");
    } else if (response!.current!.weather![0].icon == "09d" &&
        response!.current!.weather![0].id.toString() == "531") {
      return Image.asset("assets/weather_icons/lightrain.png");
    } else if (response!.current!.weather![0].icon == "10d" &&
        response!.current!.weather![0].id.toString() == "500") {
      return Image.asset("assets/weather_icons/lightrain.png");
    } else if (response!.current!.weather![0].icon == "10d" &&
        response!.current!.weather![0].id.toString() == "501") {
      return Image.asset("assets/weather_icons/rain.png");
    } else if (response!.current!.weather![0].icon == "10d" &&
        response!.current!.weather![0].id.toString() == "502") {
      return Image.asset("assets/weather_icons/heavyrain.png");
    } else if (response!.current!.weather![0].icon == "10d" &&
        response!.current!.weather![0].id.toString() == "503") {
      return Image.asset("assets/weather_icons/lightrain.png");
    } else if (response!.current!.weather![0].icon == "10d" &&
        response!.current!.weather![0].id.toString() == "504") {
      return Image.asset("assets/weather_icons/heavyrainandthunder.png");
    } else if (response!.current!.weather![0].icon == "11d" &&
        response!.current!.weather![0].id.toString() == "200") {
      return Image.asset(
          "assets/weather_icons/lightrainshowersandthunder_day.png");
    } else if (response!.current!.weather![0].icon == "11d" &&
        response!.current!.weather![0].id.toString() == "201") {
      return Image.asset("assets/weather_icons/rainshowersandthunder_day.png");
    } else if (response!.current!.weather![0].icon == "11d" &&
        response!.current!.weather![0].id.toString() == "202") {
      return Image.asset(
          "assets/weather_icons/heavyrainshowersandthunder_day.png");
    } else if (response!.current!.weather![0].icon == "11d" &&
        response!.current!.weather![0].id.toString() == "210") {
      return Image.asset("assets/weather_icons/lightrainandthunder.png");
    } else if (response!.current!.weather![0].icon == "11d" &&
        response!.current!.weather![0].id.toString() == "211") {
      return Image.asset("assets/weather_icons/rainandthunder.png");
    } else if (response!.current!.weather![0].icon == "11d" &&
        response!.current!.weather![0].id.toString() == "212") {
      return Image.asset("assets/weather_icons/heavyrainandthunder.png");
    } else if (response!.current!.weather![0].icon == "11d" &&
        response!.current!.weather![0].id.toString() == "221") {
      return Image.asset("assets/weather_icons/heavyrainandthunder.png");
    } else if (response!.current!.weather![0].icon == "11d" &&
        response!.current!.weather![0].id.toString() == "230") {
      return Image.asset(
          "assets/weather_icons/lightrainshowersandthunder_day.png");
    } else if (response!.current!.weather![0].icon == "11d" &&
        response!.current!.weather![0].id.toString() == "231") {
      return Image.asset("assets/weather_icons/rainshowersandthunder_day.png");
    } else if (response!.current!.weather![0].icon == "11d" &&
        response!.current!.weather![0].id.toString() == "232") {
      return Image.asset(
          "assets/weather_icons/heavyrainshowersandthunder_day.png");
    } else if (response!.current!.weather![0].icon == "13d" &&
        response!.current!.weather![0].id.toString() == "511") {
      return Image.asset("assets/weather_icons/lightsleet.png");
    } else if (response!.current!.weather![0].icon == "13d" &&
        response!.current!.weather![0].id.toString() == "600") {
      return Image.asset("assets/weather_icons/lightsnow.png");
    } else if (response!.current!.weather![0].icon == "13d" &&
        response!.current!.weather![0].id.toString() == "601") {
      return Image.asset("assets/weather_icons/snow.png");
    } else if (response!.current!.weather![0].icon == "13d" &&
        response!.current!.weather![0].id.toString() == "602") {
      return Image.asset("assets/weather_icons/heavysnow.png");
    } else if (response!.current!.weather![0].icon == "13d" &&
        response!.current!.weather![0].id.toString() == "611") {
      return Image.asset("assets/weather_icons/sleet.png");
    } else if (response!.current!.weather![0].icon == "13d" &&
        response!.current!.weather![0].id.toString() == "612") {
      return Image.asset("assets/weather_icons/lightsleetshowers_day.png");
    } else if (response!.current!.weather![0].icon == "13d" &&
        response!.current!.weather![0].id.toString() == "613") {
      return Image.asset("assets/weather_icons/sleetshowers_day.png");
    } else if (response!.current!.weather![0].icon == "13d" &&
        response!.current!.weather![0].id.toString() == "615") {
      return Image.asset("assets/weather_icons/lightsleet.png");
    } else if (response!.current!.weather![0].icon == "13d" &&
        response!.current!.weather![0].id.toString() == "616") {
      return Image.asset("assets/weather_icons/sleet.png");
    } else if (response!.current!.weather![0].icon == "13d" &&
        response!.current!.weather![0].id.toString() == "620") {
      return Image.asset("assets/weather_icons/lightsnowshowers_day.png");
    } else if (response!.current!.weather![0].icon == "13d" &&
        response!.current!.weather![0].id.toString() == "621") {
      return Image.asset("assets/weather_icons/snowshowers_day.png");
    } else if (response!.current!.weather![0].icon == "13d" &&
        response!.current!.weather![0].id.toString() == "622") {
